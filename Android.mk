...
LOCAL_SRC_FILES:= \
        ...
        src/preRecord/NativeCodec.cpp \
        src/preRecord/mediacodec_encoder.c \
        src/preRecord/mediacodec_utils.c \
        src/preRecord/queue.c \
        src/preRecord/queue_internal.c \
        src/preRecord/preRecord.cpp \
        src/preRecord/audio/opensl_io.c \
        src/preRecord/audio/native-audio.c \
...
LOCAL_C_INCLUDES+= \
        ...
        $(LOCAL_PATH)/src/preRecord/include \
        $(LOCAL_PATH)/src/preRecord/audio \
...
ifeq ($(TARGET_BOARD_PLATFORM),msm8974)
        ...
        LOCAL_CFLAGS += -DNUM_RECORDING_BUFFERS=5
        LOCAL_CFLAGS += -DDUMP_PRV_IN_FILE
endif
LOCAL_CFLAGS += -Wall -Wextra -Werror -Wunused-parameter

LOCAL_SHARED_LIBRARIES:= \
         libcutils libdl libmmcamera_interface libbinder libutils liblog libOpenSLES

LOCAL_MODULE_TAGS := optional

LOCAL_32_BIT_ONLY := $(BOARD_QTI_CAMERA_32BIT_ONLY)

LOCAL_MODULE:= qcamera
