...
/////////////////AmediaMuxer///////////////////////
typedef AMediaMuxer *(*pf_AMediaMuxer_new)(int , OutputFormat);
typedef media_status_t(*pf_AMediaMuxer_delete)(AMediaMuxer*);
typedef media_status_t(*pf_AMediaMuxer_setLocation)(AMediaMuxer *, float, float);
typedef media_status_t(*pf_AMediaMuxer_setOrientationHint)(AMediaMuxer *, int);
typedef ssize_t(*pf_AMediaMuxer_addTrack)(AMediaMuxer *muxer, const AMediaFormat *format);
typedef media_status_t(*pf_AMediaMuxer_start)(AMediaMuxer *muxer);
typedef media_status_t(*pf_AMediaMuxer_stop)(AMediaMuxer *muxer);
typedef media_status_t(*pf_AMediaMuxer_writeSampleData)(AMediaMuxer *muxer,	size_t trackIdx, const uint8_t *data, const AMediaCodecBufferInfo *info);
...
/////////////////AmediaMuxer///////////////////////
	struct {
		pf_AMediaMuxer_new _new;
		pf_AMediaMuxer_delete _delete;
		pf_AMediaMuxer_setLocation _setLocation;
		pf_AMediaMuxer_setOrientationHint _setOrientationHint;
		pf_AMediaMuxer_addTrack _addTrack;
		pf_AMediaMuxer_start _start;
		pf_AMediaMuxer_stop _stop;
		pf_AMediaMuxer_writeSampleData _writeSampleData;
	} AMediaMuxer;
};
...
#undef OFF
#define OFF(x) offsetof(struct dlsys, AMediaMuxer.x)
{ "AMediaMuxer_new", OFF(_new), true },
{ "AMediaMuxer_delete", OFF(_delete), true },
{ "AMediaMuxer_addTrack", OFF(_addTrack), true },
{ "AMediaMuxer_setLocation", OFF(_setLocation), true },
{ "AMediaMuxer_setOrientationHint", OFF(_setOrientationHint), true },
{ "AMediaMuxer_start", OFF(_start), true },
{ "AMediaMuxer_stop", OFF(_stop), true },
{ "AMediaMuxer_writeSampleData", OFF(_writeSampleData), true },
#undef OFF
{ NULL, 0, false }
};
#undef OFF
...
media_status_t AMediaMuxer_writeSampleData(AMediaMuxer *muxer, size_t trackIdx, const uint8_t *data, const AMediaCodecBufferInfo *info){
	return gdlsys.AMediaMuxer._writeSampleData(muxer, trackIdx, data, info);
}
#ifdef __cplusplus
}
#endif
